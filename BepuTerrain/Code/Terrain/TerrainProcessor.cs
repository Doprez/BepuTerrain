using BepuTerrain.Code.Extensions;
using BepuTerrain.Code.Terrain.Components;
...
namespace BepuTerrain.Code.Terrain;
/// <summary>
/// Generates height map models for any terrain components,
/// 
/// </summary>
public class TerrainProcessor : EntityProcessor<TerrainComponent, TerrainRenderData>, IEntityComponentRenderProcessor, ITerrainMesh
{
	public VisibilityGroup VisibilityGroup { get; set; }
	public TrackingCollection<ITerrainRenderData> TerrainModels { get; } = new();
	...
	protected override void OnSystemAdd()
	{
		...
		var physicsSystem = new TerrainPhysicsSystem(Services, this);
...
public class TerrainRenderData : ITerrainRenderData
{
